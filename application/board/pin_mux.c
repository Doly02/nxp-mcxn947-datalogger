...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t gpio0_7_pin_config = {
    		.pinDirection = kGPIO_DigitalOutput,
    		.outputLogic = 0U
    	};
	GPIO_PinInit(GPIO0, 7U, &gpio0_7_pin_config);

	const port_pin_config_t port0_7_pin_config = {/* Internal pull-up/down resistor is disabled */
													  kPORT_PullDisable,
	...
	PORT_SetPinConfig(PORT0, 7U, &port0_7_pin_config);


    gpio_pin_config_t gpio0_9_pin_config = {
    		.pinDirection = kGPIO_DigitalOutput,
    		.outputLogic = 0U
    	};
	GPIO_PinInit(GPIO0, 9U, &gpio0_9_pin_config);

	const port_pin_config_t port0_9_pin_config = {/* Internal pull-up/down resistor is disabled */
													  kPORT_PullDisable,
													  /* Low internal pull resistor value is selected. */
													  kPORT_LowPullResistor,
													  /* Fast slew rate is configured */
													  ...
													  /* Pin Control Register fields [15:0] are not locked */
													  kPORT_UnlockRegister};
	PORT_SetPinConfig(PORT0, 9U, &port0_9_pin_config);

    gpio_pin_config_t gpio0_13_pin_config = {
    		.pinDirection = kGPIO_DigitalOutput,
    		.outputLogic = 0U
    	};
	GPIO_PinInit(GPIO0, 13U, &gpio0_13_pin_config);

	const port_pin_config_t port0_13_pin_config = {/* Internal pull-up/down resistor is disabled */
													  kPORT_PullDisable,
													  /* Low internal pull resistor value is selected. */
													  kPORT_LowPullResistor,
													  /* Fast slew rate is configured */
													  ...
													  /* Pin Control Register fields [15:0] are not locked */
													  kPORT_UnlockRegister};
	PORT_SetPinConfig(PORT0, 13U, &port0_13_pin_config);


	gpio_pin_config_t gpio2_11_pin_config = {
		.pinDirection = kGPIO_DigitalOutput,
		.outputLogic = 0U
	};
	GPIO_PinInit(GPIO2, 11U, &gpio2_11_pin_config);

	const port_pin_config_t port2_11_pin_config = {/* Internal pull-up/down resistor is disabled */
													  kPORT_PullDisable,
													  /* Low internal pull resistor value is selected. */
													  kPORT_LowPullResistor,
													  /* Fast slew rate is configured */
													  ...
													  /* Pin Control Register fields [15:0] are not locked */
													  kPORT_UnlockRegister};
	PORT_SetPinConfig(PORT2, 11U, &port2_11_pin_config);

    gpio_pin_config_t gpio4_17_pin_config = {
		.pinDirection = kGPIO_DigitalOutput,
		.outputLogic = 0U
	};
	GPIO_PinInit(GPIO4, 17U, &gpio4_17_pin_config);

	const port_pin_config_t port4_17_pin_config = {/* Internal pull-up/down resistor is disabled */
													  kPORT_PullDisable,
													  /* Low internal pull resistor value is selected. */
													  kPORT_LowPullResistor,
													  /* Fast slew rate is configured */
													  ...
													  /* Pin Control Register fields [15:0] are not locked */
													  kPORT_UnlockRegister};
	/* PORT4_17 is configured as PIO4_17 */
	PORT_SetPinConfig(PORT4, 17U, &port4_17_pin_config);
    ...
    const port_pin_config_t port0_15_pin_config = {/* Internal pull-up/down resistor is disabled */
                                                      ...
                                                      /* Pin Control Register fields [15:0] are not locked */
                                                      kPORT_UnlockRegister};
    /* PORT0_15 is configured as PIO0_15 */
    PORT_SetPinConfig(PORT0, 15U, &port0_15_pin_config);

    gpio_pin_config_t gpio0_23pin_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_10)  */
    GPIO_PinInit(GPIO0, 23U, &gpio0_23pin_config);

    const port_pin_config_t port0_23_pin_config = {/* Internal pull-up/down resistor is disabled */
                                                      kPORT_PullDisable,
                                                      /* Low internal pull resistor value is selected. */
                                                      kPORT_LowPullResistor,
                                                      /* Fast slew rate is configured */
                                                      ...
                                                      /* Pin Control Register fields [15:0] are not locked */
                                                      kPORT_UnlockRegister};
    /* PORT0_23 is configured as PIO0_23 */
    PORT_SetPinConfig(PORT0, 23U, &port0_23_pin_config);
...
void BOARD_DeinitPins(void)
{
    ...
    port_pin_config_t default_config = {
        kPORT_PullDisable,
        kPORT_LowPullResistor,
        kPORT_FastSlewRate,
        kPORT_PassiveFilterDisable,
...
#if (true == TEMPERATURE_MEAS_ENABLED)
    PORT_SetPinConfig(PORT1, 16U, &default_config);
    PORT_SetPinConfig(PORT1, 17U, &default_config);
#endif

#if (true == PWRLOSS_DETECTION_ENABLED)

#if (true == PWRLOSS_TEST_GPIOS)
    /* Used For Validation of Power Loss Detection */
    //PORT_SetPinConfig(PORT0, 15U, &default_config);
    //PORT_SetPinConfig(PORT0, 23U, &default_config);
#endif /* (true == PWRLOSS_TEST_GPIOS) */

    PORT_SetPinConfig(PORT0, 22U, &default_config); // CMP1_IN2

#endif /* (true == PWRLOSS_DETECTION_ENABLED) */

#if (true == CONTROL_LED_ENABLED)
    PORT_SetPinConfig(PORT0, 7U,  &default_config);
    PORT_SetPinConfig(PORT0, 9U,  &default_config);
    PORT_SetPinConfig(PORT0, 13U, &default_config);
    PORT_SetPinConfig(PORT2, 11U, &default_config);
    PORT_SetPinConfig(PORT4, 17U, &default_config);
#endif

    /* Flexcomm Pins (UART, SPI or I2C) */
    PORT_SetPinConfig(PORT1, 8U, &default_config);
    PORT_SetPinConfig(PORT1, 9U, &default_config);
    PORT_SetPinConfig(PORT3, 2U, &default_config);
    PORT_SetPinConfig(PORT3, 3U, &default_config);
    PORT_SetPinConfig(PORT4, 0U, &default_config);
    PORT_SetPinConfig(PORT4, 1U, &default_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
